...
#cuts_tag=hf_cutflow_Wh_SR_CR_VR_September15
#cuts_tag=hf_cutflow_Wh_SR_CR_VR_September30
#cuts_tag=hf_cutflow_Wh_SR_CR_VR_September30_official_signal
#cuts_tag=hf_cutflow_Wh_SR_CR_VR_October18
cuts_tag=hf_cutflow_Wh_SR_CR_VR_October18_official_signal
...
while read did; do
  ...
  python YourMacrosAreBadAndYouShouldFeelBad.py --config config/config_qqbb_${cuts_tag}.json --out_tdirectory hists --treename nominal --eventWeight ${event_weight} --filters filters/filters_ht.json --newOutputs --copyMBJCutflow -o ${ntuple_path}/${tag}-histograms/${cuts_tag}${filter}/ ${ntuple_path}/${tag}/*${did}*.merged &
