...
cuts_tag=hf_bkgdComposition_November20
#cuts_tag=hf_Nm1_SR1_November20
#cuts_tag=hf_Nm1_SR2_November20
#cuts_tag=hf_Nm1_SR3_November20
...
#   python YourMacrosAreBadAndYouShouldFeelBad.py --config config/config_qqbb_${cuts_tag}.json --out_tdirectory hists --treename nominal --newOutputs --copyMBJCutflow --doData -o ${ntuple_path}/${out_tag}/${cuts_tag}${filter}/ ${ntuple_path}/${tag}/*${period}*.merged &
# done;
