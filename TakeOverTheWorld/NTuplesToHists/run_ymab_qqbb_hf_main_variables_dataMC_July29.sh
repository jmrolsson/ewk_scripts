...
# echo Processing: ${did}
#
# python YourMacrosAreBadAndYouShouldFeelBad.py --config config/config_qqbb_hf_main_variables_dataMC_July29.json --out_tdirectory hists --treename nominal --eventWeight "weight_mc*weight_btag*weight_elec*weight_muon*weight_jvt" --filters filters/filters_ht.json --newOutputs --copyMBJCutflow -o ${ntuple_path}/${tag}-histograms/hf_main_variables_dataMC_July29/ ${ntuple_path}/${tag}/*${did}*.merged &
#
...
# python YourMacrosAreBadAndYouShouldFeelBad.py --config config/config_qqbb_hf_main_variables_dataMC_July29.json --out_tdirectory hists --treename nominal --newOutputs --copyMBJCutflow --doData -o ${ntuple_path}/${tag}-histograms/hf_main_variables_dataMC_July29/ ${ntuple_path}/${tag}/*period*data*.merged &
...
##    python YourMacrosAreBadAndYouShouldFeelBad.py --config config/config_qqbb_hf_main_variables_dataMC_July29.json --out_tdirectory hists --treename nominal --newOutputs --copyMBJCutflow --doData -o ${ntuple_path}/${tag}-histograms/hf_main_variables_dataMC_July29_new/ ${ntuple_path}/${tag}/*${period}*.merged &
##  done;
