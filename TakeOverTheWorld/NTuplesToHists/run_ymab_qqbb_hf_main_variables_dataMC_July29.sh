...
# echo Processing: ${did}
#
# python YourMacrosAreBadAndYouShouldFeelBad.py --config config/config_qqbb_hf_main_variables_dataMC_July29.json --out_tdirectory hists --treename nominal --eventWeight "weight_mc*weight_btag*weight_elec*weight_muon*weight_jvt" --filters filters/filters_ht.json --newOutputs --copyMBJCutflow -o ${ntuple_path}/histograms/hf_main_variables_dataMC_July29/ ${ntuple_path}/${tag}/*${did}*.merged &
#
#done <dids_to_process_HT_incl_filter.txt

python YourMacrosAreBadAndYouShouldFeelBad.py --config config/config_qqbb_hf_main_variables_dataMC_July29.json --out_tdirectory hists --treename nominal --eventWeight "weight_mc*weight_btag*weight_elec*weight_muon*weight_jvt" --filters filters/filters_ht.json --newOutputs --copyMBJCutflow -o ${ntuple_path}/histograms/hf_main_variables_signal_only/ ${ntuple_path}/${tag}/*C1N2_Wh*.merged
