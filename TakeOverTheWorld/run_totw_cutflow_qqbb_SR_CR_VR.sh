#python totw_cutflow.py -b --config config/config_totw_qqbb_hf_cutflow_Wh_SR_CR_VR_August14.yml --weights weights_qqbb.json -i hists --lumi 36.1 --debug --latex
#python totw_cutflow.py -b --config config/config_totw_qqbb_hf_cutflow_Wh_SR_CR_VR_August15.yml --weights weights_qqbb.json -i hists --lumi 36.1 --debug --latex --json
#python totw_cutflow.py -b --config config/config_totw_qqbb_hf_cutflow_Wh_SR_CR_VR_August20.yml --weights weights_qqbb.json -i hists --lumi 36.1 --debug --latex --json
#python totw_cutflow.py -b --config config/config_totw_qqbb_hf_cutflow_Wh_CR_singletop_August22.yml --weights weights_qqbb.json -i hists --lumi 36.1 --debug --latex --json
