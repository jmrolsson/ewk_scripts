...
def init_hist(label, x_min, x_max, y_min, y_max, x_bin_size, y_bin_size, name="grid", x_label="m(#tilde{g}) [GeV]", y_label="m(#tilde{#chi}^{0}_{1}) [GeV]"):
    return ROOT.TH2F(name,
                axis_labels(z_label=label, x_label=x_label, y_label=y_label),
