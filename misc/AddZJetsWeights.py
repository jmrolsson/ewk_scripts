...
def main(argv):
    ...
    #fileWithWeights = "/path/to/VJetsWeights.root"
    #fileWithWeights = "/share/t3data2/jolsson/EWK/Vjets_SysParametrization/AllVariations.root"
    #fileWithWeights = "/Users/joakim/ewk/Vjets_SysParameterization/AllVariationWeights.root"
    fileWithWeights = "/Users/joakim/ewk/Vjets_SysParameterization/VJetsWeights.root"
    ...
    nEvts = T.GetEntries()
    print "Number of events to process:", nEvts
    for iEvt in range(nEvts):
        ...
        #mcid = t.mcid
        #ntruthjets = t.njets
        MCID = T.channel_number
        nTruthJets = T.truth_jets_n
        print "iEvt", iEvt
        print "MCID", MCID
        print "nTruthJets", nTruthJets
